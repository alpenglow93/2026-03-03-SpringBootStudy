...
@RestController
@RequiredArgsConstructor // 반드시 스프링에서 메모리 할당이 된 경우만 사용이 가능
public class AuthController 
{
			...
			@RequestParam(value = "password", required = false) String password) 
	{
		...
		String token = provider.createToken(user.getUsername(), user.getAuthorities().iterator().next().getAuthority());
